...
def _blinq_logo_source() -> str:
    return _image_data_uri((
        "blinq/web/assets/Thinq_logo.png",
        "blinq/web/assets/blinq_logo.png",
        "blinq/assets/Thinq_logo.png",
        "corq/web/assets/Thinq_logo.png",
    ))
...
<style>
:root{--bg:#07111f;--panel:#0e1b2d;--line:#29405e;--text:#eef5ff;--muted:#8fa4bd;--cyan:#38d5ff;--green:#61d6a7;--warn:#ffcc66}*{box-sizing:border-box}body{margin:0;background:radial-gradient(circle at top left,#10233d,#07111f 45%,#050b14);color:var(--text);font:14px/1.5 Inter,Segoe UI,Roboto,Arial,sans-serif;-webkit-font-smoothing:antialiased;text-rendering:optimizeLegibility;min-height:100vh}.wrap{max-width:1480px;margin:0 auto;padding:18px 24px}.topbar{display:flex;align-items:center;gap:18px;min-height:72px}.brand{display:flex;align-items:center;gap:12px;min-width:230px}.brand-mark{width:56px;height:56px;border-radius:50%;border:1px solid rgba(56,213,255,.75);box-shadow:0 0 22px rgba(56,213,255,.2);overflow:hidden;background:#071827}.brand-logo{width:100%;height:100%;object-fit:contain}.brand-title{font-family:inherit;font-weight:800;font-size:17px;letter-spacing:-.02em}.brand-sub{font-size:9px;color:var(--muted);letter-spacing:.16em;text-transform:uppercase}.nav{display:flex;gap:8px;flex-wrap:wrap}.nav a{color:#bcd1ea;text-decoration:none;border:1px solid #22344d;background:#0d1727;padding:7px 12px;border-radius:999px;font-weight:700}.nav a.active{border-color:var(--cyan);color:#fff;box-shadow:0 0 16px rgba(56,213,255,.16)}.hero{display:grid;grid-template-columns:repeat(3,1fr);gap:14px;margin:10px 0 22px}.hero-panel{background:linear-gradient(180deg,rgba(17,29,47,.92),rgba(9,17,30,.92));border:1px solid #23344d;border-radius:16px;padding:15px 17px;min-height:86px}.hero-title{font-size:11px;color:var(--cyan);text-transform:uppercase;letter-spacing:.14em;font-weight:900}.hero-line{margin-top:8px;color:#dbeafe;font-size:13px;line-height:1.55}.content{width:min(980px,100%);margin:auto;padding:12px 0 32px}.blinq-logo-wrap{display:flex;justify-content:center;align-items:center;width:min(360px,78vw);height:122px;margin:4px auto 22px;overflow:hidden;-webkit-mask-image:radial-gradient(ellipse 78% 72% at center,#000 58%,transparent 100%);mask-image:radial-gradient(ellipse 78% 72% at center,#000 58%,transparent 100%)}.blinq-logo{display:block;width:100%;height:100%;object-fit:cover;object-position:center;transform:scale(1.26);mix-blend-mode:screen;filter:drop-shadow(0 10px 28px rgba(0,0,0,.28));image-rendering:auto}.blinq-logo-fallback{font-size:42px;font-weight:800;letter-spacing:-.04em;color:#fff}.lead{color:var(--muted)}.card,.result,.history{background:rgba(14,27,45,.96);border:1px solid var(--line);border-radius:18px;padding:24px;box-shadow:0 22px 70px #0006}.grid{display:grid;grid-template-columns:1fr 1fr;gap:18px}label{display:block;color:#d2e1f2;font-size:12px;font-weight:700;margin-bottom:7px}.search{position:relative}input,select,button{width:100%;border-radius:12px;border:1px solid #2b4668;background:#081525;color:var(--text);padding:13px;font:inherit}input:focus{outline:none;border-color:var(--cyan)}.drop{display:none;position:absolute;z-index:20;top:52px;left:0;right:0;max-height:300px;overflow:auto;background:#091524;border:1px solid #315072;border-radius:12px;padding:6px;box-shadow:0 18px 45px #000b}.drop.open{display:block}.opt{display:block;width:100%;text-align:left;border:0;background:transparent;color:var(--text);margin:0;padding:10px;cursor:pointer}.opt:hover{background:#14263e}.opt small{display:block;color:var(--muted);margin-top:2px}.selected{min-height:24px;color:var(--green);font-size:12px;padding-top:6px}.controls{display:grid;grid-template-columns:220px 1fr;gap:14px;align-items:end;margin-top:17px}.run{background:linear-gradient(90deg,var(--green),var(--cyan));color:#04120d;border:0;font-weight:900;cursor:pointer}.run:disabled{opacity:.4;cursor:not-allowed}.help{color:var(--muted);font-size:12px}.error{color:#ff8a68;font-weight:700}.result{display:none;margin-top:16px}.winner{font-size:28px;font-weight:900}.status{color:var(--green);font-weight:900}.prob-bar{display:flex;height:14px;border-radius:999px;overflow:hidden;background:#172a43;margin-top:16px}.prob-left{background:linear-gradient(90deg,var(--green),#43c9c3)}.prob-right{background:linear-gradient(90deg,#559ff7,#766de8)}.prob-labels{display:flex;justify-content:space-between;color:var(--muted);font-size:11px;margin-top:6px}.metrics{display:grid;grid-template-columns:repeat(5,1fr);gap:9px;margin-top:16px}.metric{padding:12px;background:#091524;border:1px solid var(--line);border-radius:11px;color:var(--muted)}.metric b{display:block;color:var(--text);font-size:17px;margin-top:4px}.history{margin-top:16px}.history-head{display:flex;justify-content:space-between;align-items:center}.history-head h2{font-size:17px;font-weight:700;letter-spacing:-.01em;margin:0}.clear{width:auto;padding:8px 12px;background:transparent;color:var(--muted);border:1px solid var(--line)}.history-list{display:grid;gap:8px;margin-top:14px}.history-row{display:grid;grid-template-columns:1fr auto 1fr auto;gap:10px;align-items:center;background:#091524;border:1px solid var(--line);border-radius:11px;padding:11px}.empty{color:var(--muted)}.auth-card{position:relative;margin:0 auto 18px;background:linear-gradient(180deg,rgba(13,29,49,.96),rgba(8,20,35,.96));border:1px solid #294766;border-radius:18px;padding:18px;box-shadow:0 18px 55px rgba(0,0,0,.22)}.auth-row{display:grid;grid-template-columns:minmax(220px,1.35fr) minmax(180px,1fr) auto auto auto;gap:10px;align-items:center}.auth-row input{width:100%;min-width:0}.auth-row button{width:auto;min-height:46px;padding:11px 15px;cursor:pointer;font-weight:700;white-space:nowrap;transition:.18s ease}.auth-row button:hover{border-color:#4f7eaa;background:#10243b;transform:translateY(-1px)}.auth-row button:disabled{opacity:.5;cursor:not-allowed}.access-note{color:var(--muted);font-size:12px;margin-top:10px}.free-note{position:static;margin:12px 2px 0;color:#72e8bd;text-align:right;font-size:11px}.auth-message{min-height:0;font-size:12px}.auth-message:not(:empty){display:flex;align-items:center;gap:8px;margin-top:12px;padding:9px 11px;border-radius:10px;border:1px solid rgba(132,164,196,.28);background:rgba(99,129,158,.08);color:#afc4da;font-weight:600}.auth-message:not(:empty)::before{content:"";width:6px;height:6px;border-radius:50%;background:#7f9bb7;flex:0 0 auto}.auth-message.error{color:#d9a995;border-color:rgba(210,137,105,.28);background:rgba(168,91,62,.08)}.auth-message.error::before{background:#d28a6a}.auth-message.success{color:#91d9bc;border-color:rgba(97,214,167,.25);background:rgba(63,161,126,.07)}.auth-message.success::before{background:#61d6a7}.footer{margin:24px 0 6px;text-align:center;color:#6f86a4;font-size:11px}@media(max-width:1100px){.auth-row{grid-template-columns:1fr 1fr}.auth-row button{width:100%}}@media(max-width:900px){.topbar{align-items:flex-start;flex-direction:column}.hero{grid-template-columns:1fr}.hero-panel{min-height:auto}}@media(max-width:760px){.wrap{padding:12px}.grid,.controls,.metrics,.history-row,.auth-row{grid-template-columns:1fr}.brand-mark{width:54px;height:54px}.blinq-logo-wrap{width:min(360px,92vw);height:128px}.auth-card{padding-bottom:14px}.free-note{position:static;margin-top:10px;text-align:left}}
</style></head><body><div class="wrap"><header><div class="topbar"><div class="brand"><span class="brand-mark"><img class="brand-logo" src="__LOGO__" alt="BackstageTalks"></span><div><div class="brand-title">BackstageTalks</div><div class="brand-sub">Statistical Engine</div></div></div></div><div class="hero"><div class="hero-panel"><div class="hero-title">Who we are</div><div class="hero-line">Independent tennis intelligence for data-driven fans, analysts, and enthusiasts.</div></div><div class="hero-panel"><div class="hero-title">What we do</div><div class="hero-line">We transform match data into explainable models and measurable insights.</div></div><div class="hero-panel"><div class="hero-title">Why we do it</div><div class="hero-line">Because tennis analysis should be driven by evidence, not hype, reputation, or guesswork.</div></div></div></header><main class="content"><div class="blinq-logo-wrap">__BLINQ_LOGO__</div><section class="auth-card"><div id="signedOut"><div class="auth-row"><input id="authEmail" type="email" placeholder="Email"><input id="authPassword" type="password" placeholder="Password"><button id="signIn">Sign in</button><button id="signUp">Create account</button><button id="forgotPassword">Forgot password</button></div><div class="access-note free-note">New accounts receive 10 free successful predictions.</div><div id="authMessage" class="auth-message" aria-live="polite"></div></div><div id="signedIn" style="display:none"><div class="auth-row"><b id="userEmail"></b><span id="credits"></span><button id="checkAccess">Check access status</button><button id="signOut">Sign out</button></div><div id="accessMessage" class="access-note"></div></div></section><section class="card"><div class="grid"><div><label>Player 1</label><div class="search"><input id="p1" autocomplete="off" placeholder="Type at least 2 characters"><div id="d1" class="drop"></div></div><div id="s1" class="selected"></div></div><div><label>Player 2</label><div class="search"><input id="p2" autocomplete="off" placeholder="Type at least 2 characters"><div id="d2" class="drop"></div></div><div id="s2" class="selected"></div></div></div><div class="controls"><div><label>Surface</label><select id="surface"><option value="elo">Overall</option><option value="hard_elo">Hard</option><option value="clay_elo">Clay</option><option value="grass_elo">Grass</option></select></div><button id="run" class="run" disabled>Calculate prediction</button></div><p class="help">Type at least 2 characters and select two different players.</p></section><section id="result" class="result"></section><section class="history"><div class="history-head"><h2>Comparison history</h2><button id="clear" class="clear">Clear</button></div><div id="history" class="history-list"></div></section><footer class="footer">__DISCLAIMER__</footer></main></div>
<script>
const SUPABASE_URL='__SUPABASE_URL__',SUPABASE_PUBLISHABLE_KEY='__SUPABASE_PUBLISHABLE_KEY__';const sb=(SUPABASE_URL&&SUPABASE_PUBLISHABLE_KEY&&window.supabase)?supabase.createClient(SUPABASE_URL,SUPABASE_PUBLISHABLE_KEY):null;let accessToken='';const authMessage=document.getElementById('authMessage');const friendlyAuthError=message=>{const m=String(message||'').toLowerCase();if(m.includes('database error saving new user'))return 'We could not create the account right now. Please try again in a moment.';if(m.includes('user already registered'))return 'An account with this email already exists. Try signing in instead.';if(m.includes('invalid login credentials'))return 'The email or password is incorrect.';if(m.includes('password'))return 'Please check the password requirements and try again.';return String(message||'Account service is temporarily unavailable.');};const setAuthMessage=(text,state='')=>{authMessage.textContent=text||'';authMessage.classList.remove('error','success');if(state)authMessage.classList.add(state)};if(!sb){setAuthMessage('Account service is temporarily unavailable. Please try again later.','error');['signIn','signUp','forgotPassword'].forEach(id=>document.getElementById(id).disabled=true)}
